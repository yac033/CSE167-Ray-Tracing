...
RM = /bin/rm -f
all: SceneViewer
SceneViewer: Image.o main.o Shader.o Camera.o Obj.o Scene.o RTScene.o shaders/lighting.frag shaders/projective.vert
	$(CC) -o SceneViewer main.o Shader.o Camera.o Obj.o Image.o Scene.o RTScene.o $(LDFLAGS)
